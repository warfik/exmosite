...
public class BalanceController {
    ...
    public ResponseEntity<List<BalanceHistoryPoint>> getBalanceHistory() {
        // Вызываем обновленный метод, который возвращает данные только за последние 24 часа
        List<BalanceHistoryPoint> history = balanceHistoryService.getHourlyBalanceHistoryForLast24h();
